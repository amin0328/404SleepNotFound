              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontFamily: 'Jost',
                              fontSize: 18,
                              fontWeight: selectedHousing == 'on-campus'
                                  ? FontWeight.w700
                                  : FontWeight.w400,
                              color: selectedHousing == 'on-campus'
                                  ? Color(0xff001743)
                                  : Colors.grey,
                            ),
                          ),
                        ...
                        GestureDetector(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontFamily: 'Jost',
                              fontSize: 18,
                              fontWeight: selectedHousing == 'off-campus'
                                  ? FontWeight.w700
                                  : FontWeight.w400,
                              color: selectedHousing == 'off-campus'
                                  ? Color(0xff001743)
                                  : Colors.grey,
                            ),
                          ),
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ProfileSetup4Screen()),
                    );
                  },
                    ),
                  ],
